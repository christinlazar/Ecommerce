...
userRoute.get('/',userBlockingMiddleware.userBlockingMiddleware,userController.loadRealHome)
...
userRoute.get('/home',userBlockingMiddleware.userBlockingMiddleware,userController.loadHome)
...
userRoute.get('/cart',userBlockingMiddleware.userBlockingMiddleware,userAuth.isLogout,cartController.loadCart)
userRoute.post('/userproductdetail',userBlockingMiddleware.userBlockingMiddleware,userAuth.isLogout,cartController.addToCart)
userRoute.patch('/removefromcart',userBlockingMiddleware.userBlockingMiddleware,userAuth.isLogout,cartController.removefromcart)
...
userRoute.get('/newpassword',userAuth.isLogout,userController.newPasswordSetup)
userRoute.post('/newpassword',userController.verifyNewPassword)
userRoute.get('/newforgototp',userAuth.isLogout,userController.loadNewForgotOtp)
...
userRoute.get('/aboutus',userAuth.isLogout,userController.loadAboutUs)
